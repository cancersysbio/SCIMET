...
inferI_file = open("SimulParamStats_SN_u"+str(mu)+"_metTime"+str(met_time)+"_"+str(repl)+".txt","w")
...
for itree in range(0,len(pri_tree_array)):
    ...
    starting_deme,mutlineage,new_mut_index = initiateFirsDeme_neutral(starting_cells,mutlineage,new_mut_index,m_prob)
